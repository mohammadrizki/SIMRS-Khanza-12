...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakHasilLab.setText("Numerik Kategorik ID");
        MnCetakHasilLab.setToolTipText("Hasil laboratorium numerik, ordinal, dan nominal Bahasa Indonesia");
        MnCetakHasilLab.setName("MnCetakHasilLab"); // NOI18N
        MnCetakHasilLab.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab1.setText("Numerik Kategorik  EN");
        MnCetakHasilLab1.setToolTipText("Hasil laboratorium numerik, ordinal, dan nominal Bahasa Inggris");
        MnCetakHasilLab1.setName("MnCetakHasilLab1"); // NOI18N
        MnCetakHasilLab1.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab2.setText("Kualitatif ID");
        MnCetakHasilLab2.setName("MnCetakHasilLab2"); // NOI18N
        MnCetakHasilLab2.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab3.setText("Kualitatif EN");
        MnCetakHasilLab3.setName("MnCetakHasilLab3"); // NOI18N
        MnCetakHasilLab3.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab4.setText("Deskriptif ID");
        MnCetakHasilLab4.setName("MnCetakHasilLab4"); // NOI18N
        MnCetakHasilLab4.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab5.setText("Deskriptif EN");
        MnCetakHasilLab5.setName("MnCetakHasilLab5"); // NOI18N
        MnCetakHasilLab5.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab6.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab7.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab8.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab9.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab10.setPreferredSize(new java.awt.Dimension(190, 26));
        ...
        MnCetakHasilLab22.setPreferredSize(new java.awt.Dimension(190, 26));
   ...
   if(tabMode.getRowCount()!=0){
    ...
    private void MnCetakHasilLab1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLab1ActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            JOptionPane.showMessageDialog(null,"Maaf, gagal mencetak. Pilih dulu data yang mau dicetak.\nKlik No.Rawat pada tabel untuk memilih!");
        }else if(!(Kd2.getText().trim().equals(""))){    
            try {         
                ps4=koneksi.prepareStatement(
                    "select periksa_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.umur,petugas.nama,DATE_FORMAT(periksa_lab.tgl_periksa,'%d-%m-%Y') as tgl_periksa,periksa_lab.jam,periksa_lab.nip,"+
